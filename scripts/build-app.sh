...
main() {
    ...
    *)
    ...
    # # Setup env path - when it is not yet set
    # CUR_DIR="$(pwd)"

    # if [ -x "$(command -v java)" ] && [ ! -z "$JAVA_HOME" ]; then
    #     echo "Java path is already setup"
    # else
    #     export JAVA_HOME="${CUR_DIR}/java"
    #     PATH=$PATH:$JAVA_HOME/bin
    # fi

    # if [ -x "$(command -v mvn)" ]; then
    #     echo "Maven path is already setup"
    # else
    #     export MVN_HOME="${CUR_DIR}/maven"
